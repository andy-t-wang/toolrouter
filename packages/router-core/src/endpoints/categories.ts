export const ENDPOINT_CATEGORY_DEFINITIONS = Object.freeze([
  {
    ...
    recommended_endpoint_id: "fal.image_fast",
  ...
  },
  {
    ...
    recommended_endpoint_id: "exa.contents",
  ...
  },
  {
    ...
    recommended_endpoint_id: "run402.prototype",
    use_cases: ["batch jobs", "transforms", "sandboxed execution"],
  },
  {
    id: "knowledge",
    name: "Knowledge",
    description: "Calculate answers, retrieve facts, and inspect structured knowledge results.",
    recommended_endpoint_id: "wolframalpha.result",
    use_cases: ["calculation", "factual answers", "structured knowledge"],
  },
  {
    id: "productivity",
    name: "Productivity",
    description: "Email, calendar, documents, task, and workspace actions.",
    recommended_endpoint_id: "agentmail.pods",
  ...
  },
  {
    ...
    recommended_endpoint_id: "flightaware.flight_track",
