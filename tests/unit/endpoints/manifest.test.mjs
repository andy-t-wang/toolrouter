...
const SNAPSHOT_BASELINE = Object.freeze({
  ...
  "stabletravel.locations": {
    ...
    field_order: ["keyword", "sub_type", "country_code", "limit", "view"],
  },
  "stabletravel.google_flights_search": {
    ...
    field_order: ["departure_id", "arrival_id", "outbound_date", "type", "adults", "currency", "hl"],
  },
  ...
  "stabletravel.flightaware_flights": {
    ...
    field_order: ["ident", "ident_type", "max_pages"],
  },
