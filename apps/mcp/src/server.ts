  ...
  if (kind === "stabletravel_google_flights_search") {
    return {
      properties: {
        ...
        type: { type: "string", enum: ["1", "2", "3"], description: "1 round trip, 2 one way, 3 multi-city." },
        ...
        include_airlines: { oneOf: [{ type: "string" }, { type: "array", items: { type: "string" } }] },
        exclude_airlines: { oneOf: [{ type: "string" }, { type: "array", items: { type: "string" } }] },
  ...
  if (kind === "stabletravel_hotels_list") {
    return {
      properties: {
        ...
        chain_codes: { oneOf: [{ type: "string" }, { type: "array", items: { type: "string" } }] },
        amenities: { oneOf: [{ type: "string" }, { type: "array", items: { type: "string" } }] },
