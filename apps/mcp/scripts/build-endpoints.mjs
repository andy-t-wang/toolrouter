...
const MCP_TOOL_DEFINITIONS = Object.freeze({
  ...
  "agentmail.create_inbox": Object.freeze({
    ...
    description: "Create an AgentMail inbox through ToolRouter's x402 AgentMail wrapper. This is a paid endpoint; use client_id for idempotent retries.",
  ...
  "agentmail.list_messages": Object.freeze({
    ...
    description: "List messages in an AgentMail inbox through ToolRouter.",
  ...
  "agentmail.get_message": Object.freeze({
    ...
    description: "Fetch a specific AgentMail message through ToolRouter.",
